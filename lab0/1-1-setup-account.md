...
In this course, you will use [GENI](https://www.geni.net/) to run lab experiments. 
...
Enter file in which to save the key (/users/gsathish01/.ssh/id_rsa): 
Enter passphrase (empty for no passphrase): 
Enter same passphrase again: 
Your identification has been saved in /users/gsathish01/.ssh/id_rsa.
Your public key has been saved in /users/gsathish01/.ssh/id_rsa.pub.
The key fingerprint is:
SHA256:z1W/psy05g1kyOTL37HzYimECvOtzYdtZcK+8jEGirA gsathish01@example.com
...
* The full path to your private key (`/users/gsathish01/.ssh/id_rsa` in the example above) - copy and paste this from your terminal output,
* The full path to your public key, which has the same name as your private key but with a `.pub` extension (`/users/gsathish01/.ssh/id_rsa.pub` in the example above) - copy and paste this from your terminal output.

If you forget these, you won't be able to access resources on GENI - so hold on to this information!

Next, upload your public key to the SSH Keys section of your profile on the GENI portal: in the menu, click on your name, then on "[SSH Keys](https://portal.geni.net/secure/profile.php#ssh)", and upload your public key to that page. Your public key is the one with the `.pub` file extension.
...
GENI users are organized into projects (read more [here](https://groups.geni.net/geni/wiki/GENIConcepts#Project).) 
